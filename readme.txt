...
This plugin adds a cookie bar to your website that actually complies with ICO standards. along with a cookie control panel via the shortcode `[cbbbcookies]`.
